...
| Optimization / calibration | `core.calibration.derive_threshold`, `langres.autoresearch.blocker_optimizer.BlockerOptimizer` (Optuna) | ✅ **Partial** (threshold calibration + blocker tuning; no full `Optimizer`) |
