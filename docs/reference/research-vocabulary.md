...
| `Clusterer` slot | `ClusterStage` operation wrapping a clustering algorithm | The algorithm remains reusable; the operation places it in the topology. |
