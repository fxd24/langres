...
Generated by `examples/research/embedder_ladder.py`. Every number here is measured by that script at metric revision **1**; re-running it regenerates this file from `docs/research/20260729_lfm25_base_encoders_rows.jsonl`.
