...
call, ids only); :mod:`langres.curation.harvest` turns answered reviews back into
...
Import weight: pydantic + stdlib only (mirrors :mod:`langres.curation.harvest`),
...
class ReviewItem(BaseModel):
    ...
    ``JudgementLog`` line format and ``langres.curation.harvest.Correction``, so a
    ...
    *,
    ...
    Args:
        ...
        corrections: Already-answered pairs (e.g.
            ``langres.curation.harvest.Correction`` objects, or anything with
