...
# The student is a RandomForestMatcher -- skip cleanly where scikit-learn (the [trained]
...
#: Small AG subset keeps the RandomForestMatcher fit + fixture materialization quick.
_AG_MAX_PAIRS = 300
...
def test_ag_fixtures_span_both_label_classes(tmp_path: Path) -> None:
    """Materialized AG fixtures carry both label classes (else RandomForestMatcher.fit crashes)."""
    import json
